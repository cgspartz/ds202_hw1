...
3. Write a paragraph to introduce yourself. Set your name in bold font and your major in italic. 
    ...
    Answer: Hi my name is **Christopher Spartz**, I am majoring in *Computer Science* and this is my senior year. I am from the chicago         suburbs, and I enjoy playing video games and reading books. I am looking to minor in Data science and really enjoy looking at how data      can tell a story. I thought that Data Science would help add an interesting set of classes to take before leaving Iowa State.
...
4. Write a paragraph describing a job that you think is related to data science. Include a hyperlink and an image. Make sure your answer is in a nice format to read. 
    ...
    Answer: A job that I think is related to Data Science would be something like risk analysis where a company needs to look at and analyze     previous data in order to accurately assess new data. [Link to an article about data science and machine learning in assessing risk](https://towardsdatascience.com/credit-risk-modeling-with-machine-learning-8c8a2657b4c4) ![Data Science Jobs](/Users/chrisspartz/Documents/School/data-science-jobs-infographic.jpeg)
  
5. What data topic will you be most interested in? (Optional) Provide a source of such dataset if you have.

    Answer: I think that one of the topics that I will be most interested in is sports since I enjoy watching baseball, and that is a sport     which has a lot of freely available and easily accessible data. 
